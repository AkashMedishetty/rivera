      ...
      <div className="mx-auto max-w-[1440px] px-5 md:px-10">
        ...
        <ul className="mt-16 grid grid-cols-1 gap-x-6 gap-y-0 md:grid-cols-2">
          {recentDeliveries.map((d, i) => (
            ...
            >
              <div className="grid grid-cols-12 gap-x-5 items-baseline">
                <span className="col-span-2 md:col-span-1 font-mono text-[0.72rem] tracking-[0.2em] text-[var(--color-ink-faint)]">
